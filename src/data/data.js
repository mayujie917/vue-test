export const list = [
...

  {
    ...
    type: 4,
    question:
      "2、某市东环路100cm号为投递站点，投递人员按照上述区域合理设计路线，保障邮件优先级，同时在不违反交通规则的前提下，投递线路为最优。（投递出班时间为每日8:30，每投递一个邮件需要7分钟）",
    images: [
      {
...

  {
    ...
    type: 5,
    question:
      "3、请从一下寄递物品图片中选出禁寄物品。(本题总计20分,选对一题5分)",
    images: [
      {
