...
export const cityList = [
  { cityValue: "1", cityName: "北京市", province:'北京市' },
  { cityValue: "2", cityName: "天津市", province: '天津市' },
  { cityValue: "17", cityName: "湖北省", province: '武汉市' },
  { cityValue: "5", cityName: "河北省", province: '石家庄市'  },
  { cityValue: "3", cityName: "上海市", province: '上海市'  },
  { cityValue: "6", cityName: "山西省", province: '太原市'  },
  { cityValue: "14", cityName: "江西省", province: '南昌市'  },
  { cityValue: "13", cityName: "福建省", province: '福州市'  },
  { cityValue: "4", cityName: "重庆市", province: '重庆市' },
  { cityValue: "16", cityName: "河南省", province: '郑州市'  },
  { cityValue: "11", cityName: "浙江省", province: '杭州市'  },
  { cityValue: "15", cityName: "山东省", province: '济南市'  },
  { cityValue: "7", cityName: "辽宁省", province: '沈阳市' },
  { cityValue: "9", cityName: "黑龙江省", province: '哈尔滨市' },
  { cityValue: "10", cityName: "江苏省", province: '南京市'  },
  { cityValue: "22", cityName: "贵州省", province: '贵阳市'  },
  { cityValue: "12", cityName: "安徽省", province: '合肥市'  },
  { cityValue: "20", cityName: "海南省", province: '三亚市'  },
  { cityValue: "23", cityName: "云南省", province: '昆明市'  },
  { cityValue: "21", cityName: "四川省", province: '成都市'  },
];
...
export const list = [
  ...
  },
  {
    // 根据图片显示快递费用， 输入对应的费用
    type: 3, // 输入费用
    question: "3、根据所给的“国内快递基础资费表”，在横线处填写资费",
    images: [
      {
  ...
  },
  {
    ...
    type: 4,
    question:
      "8、某市东环路100cm号为投递站点，投递人员按照上述区域合理设计路线，保障邮件优先级别，同时在不违反交通规则的前提下，投递线路为最优。（投递出班时间为每日8:30，每投递一个邮件需要7分钟)",
    images: [
      {
